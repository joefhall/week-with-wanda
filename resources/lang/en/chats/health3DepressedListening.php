...
return [
    ...
    */
    ...
    'wanda' => [
      ...
      'bitWorried' => "Actually though :name, I am a little concerned about you...",
      ...
      'society' => "What, you think losing is out somehow?",
    ...
    'user' => [
      ...
      'howKnowYes' => "Yes of course",
      'howKnowNo' => "No not really",
      'theyAre' => "They are?",
      'theresMore' => "There's more?",
      'iSee' => "I see...",
      'ok' => "Ok...",
      'useful' => "This is so useful. :useThanks1",
      'unsure' => ":userUnsure",
      'terrifying' => "This is terrifying",
      'learnGreat' => ":userGreat",
      'learnThanks' => ":useThanks1",
      'cool' => "Cool",
