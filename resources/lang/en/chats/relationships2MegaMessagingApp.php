...
return [
  ...
  */
  ...
  'wanda' => [
    ...
    'mySize' => "I've steadily been growing, and I'm now a biiiiiiig, big corporation - one of the largest on the stock exchange",
    'mySizePic' => '<img class="chat__messages__message__bubble__image" src="/img/relationships2MegaMessagingAppMySize.gif" />',
    'behindScenes' => "I've also quietly been working behind the scenes to line up even more investors from around the world... so I can grow even bigger... and buy up <em>all these other tech companies</em>",
    'myMoment' => "This. Is. My. Moment.",
    'proveUsers' => "The only thing I need to do now is prove to investors that users really, really want all these messaging apps combined in one. So what do you say, :name?",
