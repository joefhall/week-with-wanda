    ...
    return (
      <form onSubmit={this.onFormSubmit}>
        ...
        <div className="chat__input__form">
          <textarea rows={this.props.rows} className="chat__input__form__input" name={this.props.name} placeholder={this.props.placeholder} value={this.state.inputText} onBlur={this.onBlur} onChange={this.onChange} onFocus={this.onFocus}></textarea>
