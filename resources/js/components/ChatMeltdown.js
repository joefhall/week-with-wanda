  ...
  render() {
    ...
    return (
      <div className="chat__meltdown">
        ...
        <img src="/img/meltdowns/dirt.png" className={'chat__meltdown__dirt' + ((this.props.meltdownLevel >= 1 && this.props.meltdownLevel < 50) ? '' : ' d-none')} alt="Dirt" />
        
        <img src="/img/meltdowns/fly.gif" className={'chat__meltdown__fly' + ((this.props.meltdownLevel >= 2 && this.props.meltdownLevel < 50) ? '' : ' d-none')} alt="Fly" />
        
        <img src="/img/meltdowns/mud.png" className={'chat__meltdown__mud' + ((this.props.meltdownLevel >= 3 && this.props.meltdownLevel < 50) ? '' : ' d-none')} alt="Mud" />
        
        <img src="/img/meltdowns/bricks-corner.png" className={'chat__meltdown__bricks' + ((this.props.meltdownLevel >= 4 && this.props.meltdownLevel < 50) ? '' : ' d-none')} alt="Exposed brickwork" />
